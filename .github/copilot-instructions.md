...
- `docker-compose.yml` orchestrates: app, nginx, analytics, certbot
- Deploy script: `./deploy.sh` (builds + pushes to Docker Hub + restarts containers)
...
Production: Set in `docker-compose.yml` or shell environment
